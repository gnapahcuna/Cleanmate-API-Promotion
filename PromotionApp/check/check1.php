...
case when ServiceType='$ServiceType' AND ProductID IS NULL AND CategoryID IS NULL then 1 
	else 0 end as checking,
case when ServiceType='$ServiceType' AND ProductID IS NULL AND CategoryID IS NULL then PromotionName
	else '' end as checkingName,
case when ServiceType='$ServiceType' AND ProductID IS NULL AND CategoryID IS NULL then ServiceType
